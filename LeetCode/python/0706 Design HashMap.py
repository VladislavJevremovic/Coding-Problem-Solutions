...
class Bucket:
    """A single hash bucket holding (key, value) pairs scanned linearly; all
    operations are O(b) in the bucket length b."""
...
class MyHashMap(object):
    """Separate-chaining hash map: a fixed array of buckets indexed by
    key % key_space, each bucket scanned linearly (n = stored keys)."""
    ...
    def put(self, key, value):
        # Time: O(n / key_space) average   Space: O(1)
