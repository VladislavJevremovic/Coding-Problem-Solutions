...
class Solution:
    def combinationSum3(self, k: int, n: int) -> List[List[int]]:
        """Backtrack over the digits 1..9, choosing strictly increasing numbers
        and recording each path of length k that sums to n."""

        # Time: O(2^9)   Space: O(k) recursion depth
