...
class Solution1:
    def isValidBST(self, root: TreeNode) -> bool:
        """Recurse carrying an open (low, high) bound each node must lie within,
        tightening it for the left and right children."""
        ...
        def isValidBSTInRange(root: TreeNode, a: float, b: float) -> bool:
            ...
            return isValidBSTInRange(root.left, a, root.val) and isValidBSTInRange(
                root.right, root.val, b
            )
...
class Solution2:
    def isValidBST(self, root: TreeNode) -> bool:
        """Same bounded-range recursion using math.inf for the initial open
        bounds."""
        ...
        def isNodeInRange(root: TreeNode, a: int, b: int) -> bool:
            ...
            return isNodeInRange(root.left, a, root.val) and isNodeInRange(
                root.right, root.val, b
            )
