...
class Solution:
    def multiply_one_digit(
        self, digit2: str, num_zeros: int, first_number: str
    ) -> List[int]:
    ...
    def multiply(self, num1: str, num2: str) -> str:
        """Grade-school multiplication: for each digit of num2 multiply num1
        (offset by its place), then sum the partial products, all in reverse."""
