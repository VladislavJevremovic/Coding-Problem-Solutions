...
class Solution1:
    def reverseWords(self, s: str) -> str:
        """Split on whitespace, reverse each word, and rejoin with spaces."""
        # Time: O(n)   Space: O(n)
...
class Solution2:
    def reverseWords(self, s: str) -> str:
        """In-place two-pointer reversal of each space-delimited word over a
        char list."""

        # Time: O(n)   Space: O(n)   (char list)
