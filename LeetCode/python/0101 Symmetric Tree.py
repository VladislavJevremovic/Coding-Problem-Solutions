...
class Solution:
    def isSymmetric(self, root: TreeNode) -> bool:
        """Check whether the tree mirrors itself by comparing the left subtree
        against the mirrored right subtree."""
        # Time: O(n)   Space: O(h)
    ...
    def isMirrored(self, t1: TreeNode, t2: TreeNode) -> bool:
        ...
        return (
            t1.val == t2.val
            and self.isMirrored(t1.right, t2.left)
            and self.isMirrored(t1.left, t2.right)
        )
