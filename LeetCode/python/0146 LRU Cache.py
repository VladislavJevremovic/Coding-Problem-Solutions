...
class LRUCache:
    """Hash map for O(1) lookup paired with a doubly linked list ordered by
    recency; head is most-recently-used, tail is evicted on overflow."""

    # __init__/get/put: O(1)   Space: O(capacity)
