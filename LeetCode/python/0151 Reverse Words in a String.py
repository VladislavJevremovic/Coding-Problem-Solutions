...
class Solution1:
    def reverseWords(self, s: str) -> str:
        """Split on whitespace (collapsing runs), reverse the word list, and
...
class Solution2:
    ...
    def reverseWords(self, s: str) -> str:
        """Trim/normalize spaces into a char array, reverse the whole array,
        then reverse each word back to restore word order reversed."""
        # Time: O(n)   Space: O(n)
...
class Solution3:
    def reverseWords(self, s: str) -> str:
        """Scan the trimmed string word by word, pushing each word to the front
        of a deque, then join the deque."""
        # Time: O(n)   Space: O(n)
